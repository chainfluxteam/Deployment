            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                var _web3 = _this._web3;
                                _this._tokenContract.withdraw(_web3.toWei(amount, 'ether'), { from: account, gas: 600000 }, function (err, result) {
                                    if (err != null) {
                                        console.log(err);
                                        resolve(0);
                                    }
...
var UpdateproductComponent = /** @class */ (function () {
    ...
    UpdateproductComponent.prototype.show = function (proid) {
        ...
        this.pro.ViewProduct(proid).then(function (obj) {
            _this.view.push({ "pid": obj[0], "pname": obj[1], "brand": obj[2], "quantity": obj[3], "price": obj[4] });
        });
    };
...
module.exports = __webpack_require__(/*! C:\madhan\Inventory\src\main.ts */"./src/main.ts");
